...
const Breadcrumb = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(({ className, ...props }, ref) => (
  <nav
    ...
    className={cn("inline-flex items-center space-x-1 md:space-x-2", className)}
    {...props}
  />
))
...
>(({ asChild, className, ...props }, ref) => {
  return <a ref={ref} className={cn("text-sm font-medium underline-offset-4 hover:underline", className)} {...props} />
})
