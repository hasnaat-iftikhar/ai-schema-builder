  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleSubmit} {...props}>
        ...
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            <Link
              ...
              className="ml-auto text-sm underline-offset-4 hover:underline text-cryptic-accent"
            >
      ...
      <div className="text-center text-sm">
        ...
        <Link href="/signup" className="text-cryptic-accent hover:underline underline-offset-4">
          Sign up
        </Link>
      </div>
    </form>
